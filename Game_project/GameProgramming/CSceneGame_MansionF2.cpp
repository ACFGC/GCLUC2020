...
void CSceneGame_MansionF2::Init() {
	...
	mMansion3.Load("image\\bg_mansion\\bg_mansion_03.tga");
	...
	CRabbitBoss*mRabbitBoss = new CRabbitBoss(1);

	mRabbitBoss->x = 3700;
	mRabbitBoss->y = 600;
	mRabbitBoss->z = mRabbitBoss->y;



}

void CSceneGame_MansionF2::Update(){
	...
	//テクスチャをバインド
	glBindTexture(GL_TEXTURE_2D, mMansion3.mId);
	...
	if (CPlayer::mpPlayer->x >3400 && CPlayer::mpPlayer->y>150){
